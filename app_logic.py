...
kcb = pd.read_excel("/content/QUICK MART 21.5.2025.xlsx")
equity = pd.read_excel("/content/QUICKMART 21052025.xlsx")
aspire = pd.read_csv("/content/ZEDS_CARDS_TILLWISE_2025-05-21.csv")
...
match_trace.get('OUTERING6013', '❌ No match found')
